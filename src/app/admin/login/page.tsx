  ...
  return (
    <div style={{
      ...
      <form onSubmit={submit} style={{
        ...
        <div style={{ fontSize: 11, letterSpacing: "0.18em", color: "#8B7355", marginBottom: 8, fontWeight: 700 }}>
          EVOLVE — STAFF AREA
        </div>
        <h1 style={{ fontSize: 26, fontWeight: 800, margin: "0 0 8px 0", letterSpacing: "-0.01em" }}>
          Sign in to admin
        </h1>
        <p style={{ color: "#8B7355", fontSize: 14, margin: "0 0 28px 0", lineHeight: 1.5 }}>
          This area is for Evolve staff with admin access.
        </p>

        <label style={{ display: "block", fontSize: 12, color: "#8B7355", fontWeight: 600, marginBottom: 6 }}>
          Email
        </label>
        <input
          type="email"
          ...
          style={{
            ...
            background: "#0C0A09", border: "1px solid #2a2420",
            borderRadius: 8, color: "#F5F0EB", outline: "none",
